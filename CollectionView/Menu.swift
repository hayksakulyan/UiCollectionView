...
class Menu {
    ...
    func setup() {
        ...
        let p6 = Product(name: "product6", price: 120, image: UIImage(named: "p3")!)
        
        let p7 = Product(name: "product7", price: 100, image: UIImage(named: "p1")!)
        let p8 = Product(name: "product8", price: 110, image: UIImage(named: "p2")!)
        ...
        let g2 = Group(name: "Burger", products: product1)
        let g3 = Group(name: "Cheesburger", products: product1)
        let g4 = Group(name: "Pizz", products: product1)
        let g5 = Group(name: "Burger", products: product1)
        let g6 = Group(name: "Cheesburger", products: product1)
